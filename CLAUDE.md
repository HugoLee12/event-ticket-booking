...
- **Toolchain**: TypeScript pin `^5` (KHÔNG lên v7 - ts-jest chưa hỗ trợ); cockatiel pin `^3` (v4 ESM-only, Jest CJS không load được); test dùng Jest + ts-jest + Supertest, cấu hình xem services/booking/package.json.
