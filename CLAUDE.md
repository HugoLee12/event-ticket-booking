...
- Việc kế: còn lại là báo cáo GĐ4 (PLAN.md mục 7). A: mục Bảo mật (Ch.13) + bảng STRIDE + Đạo đức. B: mục Kiến trúc (Ch.17/18) + Concurrency & Resilience (Ch.14/17). Chung: Reuse & trade-off, CI/CD, Kết quả đo lường, slide + demo. A nhớ `git pull --rebase` để lấy code auth đã merge + E2E test.
