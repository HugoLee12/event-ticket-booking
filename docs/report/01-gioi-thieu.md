...
Chúng tôi chọn kịch bản **race condition ghế cuối** làm sợi chỉ đỏ xuyên suốt báo cáo, vì nó nối được cả bốn chương vào một điểm cụ thể: nó vừa là vấn đề nhất quán dữ liệu trong hệ phân tán (Ch.17), vừa là ngữ nghĩa lỗi của REST khi trả `409 Conflict` (Ch.18), vừa là tình huống cho client thử lại và cho hệ thống chịu lỗi (Ch.14); còn xác thực và phân quyền (Ch.13) là lớp bảo vệ độc lập bao quanh toàn bộ luồng.
...
Thứ nhất, về mặt kỹ thuật, xác thực và đặt vé là hai mối quan tâm tách bạch (bounded context): chúng có vòng đời, hồ sơ bảo mật và lý do thay đổi riêng, nên tách chúng là biểu hiện của **separation of concerns** ở cấp kiến trúc (Ch.18).
Sự tách này tạo ra đúng một điểm gọi service-to-service (Booking hỏi Auth về hồ sơ người dùng), và chính điểm đó cho phép chúng tôi hiện thực và chứng minh các cơ chế chịu lỗi thật của Ch.14, thứ mà một monolith gọi hàm nội bộ sẽ không có để trình bày.
...
- Mục 2 trình bày **kiến trúc** hệ thống dưới lăng kính Ch.17 và Ch.18.
- Mục 3 đi sâu vào **xử lý đồng thời và resilience** quanh kịch bản ghế cuối (Ch.14, Ch.17), phần trọng tâm kỹ thuật.
- Mục 4 trình bày **bảo mật** theo Ch.13, kèm bảng mô hình hoá mối đe doạ STRIDE.
- Mục 5 phân tích **tái sử dụng và các quyết định đánh đổi** (Ch.15, Ch.16).
- Mục 6 mô tả **CI/CD và DevOps** (Ch.25).
