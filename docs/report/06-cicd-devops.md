...
Nội dung neo vào chương Configuration Management (Chương 25) của Sommerville: tích hợp liên tục (continuous integration), dựng hệ thống tự động (system building), quản lý phiên bản (version management) và quản lý phát hành (release management).
...
Đây chính là **tích hợp liên tục** (Chương 25): thay đổi của hai người phát triển được máy hợp nhất và kiểm chứng ngay khi đẩy lên, thay vì để dồn lại rồi tích hợp thủ công một lần vào cuối, khi lỗi đã khó truy nguyên.
...
Thứ tự này là một hiện thực của nguyên tắc **dựng hệ thống tự động** (Chương 25): mỗi bước là một cổng chất lượng, và một bản phát hành chỉ ra đời khi đã qua tất cả các cổng.
...
Bước cuối của pipeline là **quản lý phát hành** (Chương 25), và nó cố ý chỉ chạy trong đúng một điều kiện: `push` vào nhánh `main`.
